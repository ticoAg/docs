---
title: "Skills"
description: "按功能细分的 agent skills、规则集与方法论目录"
---
...
- [OthmanAdi/planning-with-files](https://github.com/OthmanAdi/planning-with-files) — Claude Code skill implementing Manus-style persistent markdown planning — the workflow pattern behind the $2B acquisition.（Python；⭐ 17,048）

## Catalogs / Collections

- [anthropics/skills](https://github.com/anthropics/skills) — Public repository for Agent Skills（Python；⭐ 101,779）
- [github/awesome-copilot](https://github.com/github/awesome-copilot) — GitHub Copilot 生态的 agents / skills / instructions / configs 精选目录。（HTML；⭐ 26,816）
- [vercel-labs/agent-skills](https://github.com/vercel-labs/agent-skills) — Vercel 官方 agent skills 集合，覆盖 React、Next.js、设计与性能实践。（JavaScript；⭐ 23,755）
- [openai/skills](https://github.com/openai/skills) — Skills Catalog for Codex（Python；⭐ 15,231）
- [vercel-labs/skills](https://github.com/vercel-labs/skills) — The open agent skills tool - npx skills（TypeScript；⭐ 11,588）
