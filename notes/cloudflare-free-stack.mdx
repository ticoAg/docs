...
这页只放 Cloudflare 主线。EdgeOne、云效、飞书/Lark 已拆到独立页面：

<CardGroup cols={3}>
    <Card
        title="EdgeOne 与 tccli"
        icon="cloud"
        href="/notes/edgeone-tccli-stack"
    >
        Tencent EdgeOne Pages、`edgeone` CLI、`tccli teo`、MCP 和 Skill。
    </Card>
    <Card
        title="云效 DevOps"
    ...
    >
        云效 MCP、Codeup、Packages、流水线和工作项协作。
    </Card>
    <Card
        title="Lark CLI 与飞书 MCP"
        icon="message-circle"
        href="/notes/lark-cli-mcp-stack"
    >
